...
class Zone:
    ...
    def __init__(self, corner1, corner2):
        """Constructeur de notre classe Zone.
    ...
    @property
    def area(self):
        """Calcule de la surface d'une zone en km2"""
    ...
    def _initialize_zones(cls):
        #this method is private. We prefix the method's name with "_"
        cls.ZONES = []
...
class AgreeablenessGraph(BaseGraph):
    ...
    def __init__(self):
        super().__init__() #executes the parent's init method
